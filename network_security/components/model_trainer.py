...
# Set environment variables securely (ensure these are set elsewhere in your environment for security)
...
import dagshub
dagshub.init(repo_owner='Karthi-Mike', repo_name='NetworkSecurity', mlflow=True)
